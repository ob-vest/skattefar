...
function App() {
  ...
  const [applyStoreBededag, setApplyStoreBededag] = useState<boolean>(false);
      ...
      <Card className="w-full max-w-xl">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <Label htmlFor="church">Inkluder kirkeskat (ca. 0,66 %)</Label>
          </div>
          <div className="flex items-center gap-2">
            <input
              id="single-parent"
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              <Label htmlFor="employeePensionRate">Egen pension (%)</Label>
              <Input
            ...
            <div className="grid gap-3">
              ...
              <div className="grid grid-cols-2 text-sm">
                ...
                <span className="text-right font-medium">
                  {formatDKK(showPeriodValue(result.basis.grossIncomeAnnual))}
                </span>
              </div>
              ...
              {result.contributions.employeePensionContributionAnnual > 0 && (
                <div className="grid grid-cols-2 text-sm">
                  <span className="text-muted-foreground">Egen pension</span>
              ...
              <div className="grid grid-cols-2 text-sm">
                ...
                <span className="text-right">
                  {formatDKK(
                    showPeriodValue(result.contributions.amContributionAnnual)
                  )}
                </span>
              </div>
              <div className="grid grid-cols-2 text-sm">
              ...
              <div className="grid grid-cols-2 text-sm">
                ...
                <span className="text-right">
                  {formatDKK(
                    showPeriodValue(result.deductions.personalAllowanceAnnual)
                  )}
                </span>
              </div>
              <div className="grid grid-cols-2 text-sm">
                ...
                <span className="text-right">
                  {formatDKK(
                    showPeriodValue(result.deductions.employmentDeductionAnnual)
                  )}
                </span>
              </div>
              ...
              <div className="grid grid-cols-2 text-sm">
                ...
                <span className="text-right">
                  {formatDKK(
                    showPeriodValue(result.deductions.commutingDeductionAnnual)
                  )}
                </span>
              </div>
              <div className="grid grid-cols-2 text-sm">
              ...
              <div className="grid grid-cols-2 text-sm">
                ...
                <span className="text-right">
                  {formatDKK(showPeriodValue(result.taxes.municipalTaxAnnual))}
                </span>
              </div>
              {includeChurch && (
                <div className="grid grid-cols-2 text-sm">
              ...
              {result.taxes.stateTopTaxAnnual > 0 && (
                <div className="grid grid-cols-2 text-sm">
                  ...
                  <span className="text-right">
                    {formatDKK(showPeriodValue(result.taxes.stateTopTaxAnnual))}
                  </span>
                </div>
              )}
